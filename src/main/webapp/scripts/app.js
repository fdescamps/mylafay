...
var mylafayApp = angular.module('mylafayApp', ['http-auth-interceptor', 'tmh.dynamicLocale',
    'ngResource', 'ngRoute', 'ngCookies', 'mylafayAppUtils', 'pascalprecht.translate', 'truncate']);
